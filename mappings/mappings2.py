...
stub = modal.Stub("mappings2")
q = Queue()
pbar_lock = Lock()
# Fetch the gene description from NCBI Entrez

API_KEY = "08c3e5645f832a8ef99f034c2e9dd39a7d09"
YOUR_JSON_PATH = '/Users/danielgeorge/Documents/work/ml/bioconceptvec-explorer/bioconceptvec-explorer/embeddings/concept_glove_2.json'
...
def main():
    ...
    # Save to pickle file
    with open('/Users/danielgeorge/Documents/work/ml/bioconceptvec-explorer/bioconceptvec-explorer/datasets/concept_descriptions_2.pkl', 'wb') as f:
